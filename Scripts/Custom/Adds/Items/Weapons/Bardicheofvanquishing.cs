namespace Server.Items
{
    ...
    public class Bardicheofvanquishing : BasePoleArm
    {
        ...
        [Constructable]
        public Bardicheofvanquishing()
            : base(0xF4D)
        {
            Weight = 15.0; //Loki edit: Was 7.0
            Name = "+9 supremely accurate bardiche of vanquishing";
            AccuracyLevel = WeaponAccuracyLevel.Supremely;
            DamageLevel = WeaponDamageLevel.Vanq;
            IsRenamed = true;
        }

        public Bardicheofvanquishing(Serial serial)
            : base(serial)
        {
        }
